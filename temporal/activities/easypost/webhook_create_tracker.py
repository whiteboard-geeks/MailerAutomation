...
def create_tracker_activity(
    ...
    try:
        ...
        _send_error_email_create_tracker_failed(lead_data=lead_data, tracking_number=tracking_number, carrier=carrier, error=exc)
...
def _send_error_email_create_tracker_failed(lead_data: dict[str, Any], tracking_number: str, carrier: str, error: Exception) -> None:
    detailed_error_message = f"""
